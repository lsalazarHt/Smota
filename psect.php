			...
			<div class="container">
				...
				<section class="content-header">
	            	...
	            	<ol class="breadcrumb">
	                	...
	                	<li class="active">Sectores Operativos por Localidades</li>
	             	</ol>
	            </section>
				...
				<section class="content">
					<div class="row">
						<div class="col-md-12">
					                	...
					                	<div class="form-group">
					                		<div class="col-sm-1"></div>
					                     	...
					                     	<div class="col-sm-2">
				                      		...
				                      		<div class="col-sm-2">
				                      			<a class="btn btn-success btn btn-sm" onclick="buscarZonasOperativas()" data-toggle="tooltip" data-original-title="Buscar Sectores Operativos"><i class="fa fa-search"></i></a>
				                      		</div>
					                    </div>
				                	</div>      
			                    </div>
							...
							<div class="box">
								<div class="box-header">
			                     	<h3 class="box-title">Sectores Operativos por Localidades</h3>
			                    </div><!-- /.box-header -->
