			...
			<div class="container">
				...
				<section class="content-header">
	            	...
	            	<ol class="breadcrumb">
	                	...
	                	<li class="active">Desasignacion de Ordenes por Pantalla</li>
	             	</ol>
	            </section>
						...
						<div class="col-md-12">
							<div class="box">
								<div class="box-header">
			                     	<h3 class="box-title">Desasignacion masiva de ordenes </h3>
			                    </div><!-- /.box-header -->
			                    <div class="box-body">
			                    	...
			                    	<div class="row marginTop3">
					                	<div class="form-group">
					                     	...
					                     	<label for="txtClase" class="col-sm-2 control-label" style="margin-top:5px;"><small>Metodo de Desasignacion</small></label>
				                      		<div class="col-sm-3">
				                	...
				                	<div class="row marginTop3">
					                	<div class="form-group">
					                     	...
					                     	<label for="txtClase" class="col-sm-4 control-label" style="margin-top:5px;"><small>Criterio de Ordenamiento</small></label>
					                    </div>
				                	</div>
				                	<div class="row marginTop3">
					                	<div class="form-group">
					                     	...
					                     	<div class="col-sm-1">
				                        		<input type="text" class="form-control input-sm e e3 key" id="txtSectCod" placeholder="Codigo" onkeypress="solonumeros()">
				                      		</div>
					                     	<label class="col-sm-1 control-label text-center" style="margin-top:5px;"><small>Cero Todos</small></label>
				                      		...
				                      		<div class="col-sm-4 text-center" style="border: solid 1px; margin-left: 50px; background-color: #808080; color:white;">
				                      			<small style="margin-top: 8px;">
					                      			<input type="radio" name="critOrd" value="1" checked> Direccion &nbsp; 
				                	...
				                	<div class="row marginTop3">
					                	<div class="form-group">
					                     	...
					                     	<div class="col-sm-1">
				                        		<input type="text" class="form-control input-sm e e4 key" id="txtPqrCod" placeholder="Codigo" onkeypress="solonumeros()">
				                      		</div>
					                     	<label class="col-sm-1 control-label text-center" style="margin-top:5px;"><small>Cero Todos</small></label>
				                      		<div class="col-sm-3">
