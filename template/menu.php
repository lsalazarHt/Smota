	      ...
	      <ul class="nav navbar-nav">
	        ...
	        <li class="dropdown mResto">
	          ...
	          <ul class="dropdown-menu" role="menu">
	            ...
	            <li class="mResto"><a href="ralma.php"><i class="fa fa-circle-o"></i>Entradas y Salidas de Almacen</a></li>
	            <li class="mResto"><a href="salma.php"><i class="fa fa-circle-o"></i>Salidas Automaticas por Reposicion</a></li>
