				...
				if(cant>0){
					...
					$.ajax({
				        ...
				        success: function(data){
				        	if(data==1){
								demo.showNotification('bottom','left', 'El Lote se asigno correctamente', 2);
				        		limpiar();
				        	}else{ alert(data) }
				        }
				    });
				}else{
					demo.showNotification('bottom','left', 'Porfavor coloque una cantidad valida', 4);
				}
			}else{ 
