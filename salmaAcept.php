						...
						<div class="col-md-12">
							<div class="box">
								<div class="box-header">
			                     	<h3 class="box-title">Movimiento Inventario automatico para reposicion de cupo</h3>
			                    </div><!-- /.box-header -->
			                    <div class="box-body">
				                	...
				                	<div class="row marginTop3">
					                	<div class="form-group">
					                     	...
					                     	<div class="col-sm-9">
					                     		<textarea rows="4" class="form-control input-sm movObEntrada_border_azulv2" id="txtObser" placeholder="Observacion del movimiento"></textarea>
				                      		</div>
					                    </div>
				                	</div>
				                	<hr>
