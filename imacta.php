			...
			<div class="container">
				                		...
				                		<table id="tableDepa" class="tableJs table table-bordered table-hover table-condensed">
					                        ...
					                        <tbody id="tbodyActas">
					                        	<?php 
		                                            ...
		                                            $query ="SELECT acta.ACTANUME, tecnico.TECNNOMB, ACTAFECH, ACTAVANE, ACTAESTA
															 FROM acta
		                                                ...
		                                                while ($row=$respuesta->fetch()){
		                                                    echo 
		                                                    	'<tr onclick="buscarActa('.$row['ACTANUME'].')">
		                                                    		...
		                                                    		<td class="text-center">'.$row['ACTAESTA'].'</td>
		                                                    	</tr>';                                   
		                                                }   
		                                            }
		                                        ?>
				...
				<section class="content-header">
	            	...
	            	<ol class="breadcrumb">
	                	...
	                	<li class="active">Imprimir Acta</li>
	             	</ol>
	            </section>
						...
						<div class="col-md-12">
							<div class="box">
								<div class="box-header">
			                     	<h3 class="box-title">Imprimir Acta</h3>
			                    </div><!-- /.box-header -->
			                    <div class="box-body">
...
<script src="js/imacta.js"></script>
