			...
			<div class="container">
				...
				<section class="content-header">
	            	...
	            	<ol class="breadcrumb">
	                	...
	                	<li class="active">Registrar centificacion individual</li>
	             	</ol>
	            </section>
						...
						<div class="col-md-12">
							<div class="box">
								<div class="box-header">
			                     	<h3 class="box-title">Certificar una OT 
</h3>
			                    </div><!-- /.box-header -->
			                    <div class="box-body">
					                	...
					                	<div class="form-group">
					                		<div class="col-sm-1"></div>
					                     	<label for="txtNom" class="col-sm-2 control-label text-right" style="margin-top:5px;">Observacion</label>
				                      		<div class="col-sm-8">
				                      			<textarea id="txtObservAsign" class="form-control input-sm" placeholder="Observacion" rows="4" onclick="editor('txtObservAsign')"></textarea>
				                      		</div>
					                    </div>
				                	</div>
			                    </div>
